...
func (h *Handler) addUserToTrainerList(c *gin.Context) {

}

func (h *Handler) deleteUserFromTrainerList(c *gin.Context) {
...
func (h *Handler) getTrainerWorkoutByID(c *gin.Context) {
...
func (h *Handler) updateTrainerWorkout(c *gin.Context) {

}

func (h *Handler) deleteTrainerWorkout(c *gin.Context) {
